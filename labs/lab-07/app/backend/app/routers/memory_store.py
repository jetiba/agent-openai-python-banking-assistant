...
class MemoryStore(Store[dict[str, Any]]):
    ...
    # -- Attachments (not supported by MemoryStore) ----------------------
    async def save_attachment(self, attachment: Attachment, context: dict[str, Any]) -> None:
        raise NotImplementedError("MemoryStore does not persist attachments.")

    async def load_attachment(self, attachment_id: str, context: dict[str, Any]) -> Attachment:
        raise NotImplementedError("MemoryStore does not load attachments.")

    async def delete_attachment(self, attachment_id: str, context: dict[str, Any]) -> None:
        raise NotImplementedError("MemoryStore does not delete attachments.")
